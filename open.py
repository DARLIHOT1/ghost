...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/DARLIHOT1/ghost.git")
			os.system("rm -rf open.py")
			os.system("cp -f DARLIHOT/open.py \\.")
			os.system("rm -rf DARLIHOT1")
